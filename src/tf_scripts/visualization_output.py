...
import random
import os
from tensorflow-for-poets-2.scripts.label_image import *

def output(file_name):
    temp_dic = {"mild": 0, "severe": 0, "none": 0}
    count = {"mild": 0, "severe": 0, "none": 0}

    model_file = "src/tensorflow-for-poets-2/tf_files/retrained_graph.pb"
    label_file = "src/tensorflow-for-poets-2/tf_files/retrained_labels.txt"
